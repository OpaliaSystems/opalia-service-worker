  ...
  (project in file("worker-impl-akka"))
    .settings(
      ...
      libraryDependencies ++= Seq(
        ...
        "com.typesafe.akka" %% "akka-actor" % "2.6.13" excludeAll (exclusionRules: _*),
        "com.typesafe.akka" %% "akka-remote" % "2.6.13" excludeAll (exclusionRules: _*),
        "com.typesafe.akka" %% "akka-cluster" % "2.6.13" excludeAll (exclusionRules: _*),
        "com.typesafe.akka" %% "akka-cluster-metrics" % "2.6.13" excludeAll (exclusionRules: _*),
        "com.typesafe.akka" %% "akka-cluster-tools" % "2.6.13" excludeAll (exclusionRules: _*),
